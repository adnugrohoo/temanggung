        	...
        	<fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight"><input type="text" class="required" name="comJaminanName" value="${comJaminanforedit.comJaminanName}" id="firstname"/></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <label>Deskripsi:<span class="req">*</span></label>
                        <div class="formRight"><input type="text" class="required" name="comJaminanDesc" value="${comJaminanforedit.comJaminanDesc}" id="minChars"/></div><div class="clear"></div>
                    </div>
                
                    <c:if test="${comJaminanforedit!=null}">
                        <div class="formSubmit"><input type="submit" formmethod="POST" formaction="controler?/action=comJaminanSave&id=${comJaminanforedit.comJaminanId}" value="submit" class="redB" /></div>
                    </c:if>
                    <c:if test="${comJaminanforedit==null}">
                        <div class="formSubmit"><input type="submit" formmethod="POST" formaction="controler?/action=comJaminanSave" value="submit" class="greenB" /></div>
                    </c:if>
                    <div class="clear"></div>
                </div>

...
<jsp:include page="_headerStaffPmi.jsp"></jsp:include>
    ...
    <jsp:include page="_menuStaffPmiLeftSide.jsp"></jsp:include>
        ...
        <jsp:include page="_menuStaffPmiResponsive.jsp"></jsp:include>
            ...
            <div class="statsRow">
                <div class="wrapper">
                    <div class="controlB">
                        ...
                        <ul align="left">
                            <li>
                                <a href="controler?/action=pendonorCek&module=periksa" title=""><img src="assets/tfcrown/images/icons/control/16/pencil.png" alt=""><span>Tambah Data Periksa</span></a>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    </div>
            ...
            <!-- Dynamic table -->
            <div class="widget">
                <div class="title"><img src="assets/tfcrown/images/icons/dark/full2.png" alt="" class="titleIcon" /><h6>Daftar Periksa</h6></div>                          
                <table cellpadding="0" cellspacing="0" border="0" class="display dTable">
                    ...
                    <tbody>
                        <%int i = 1;%>
                        <c:forEach items="${periksas}" var="periksa">    
                            <tr class="gradeX">
                                <td>
                                    <%=i%>
                                </td>
                                <td>
                                    ${periksa.pendonor.getPendonorNo()}
                                </td>
                                <td>
                                    ${periksa.getPeriksaTanggal()}
                                </td>
                                <td>
                                    ${periksa.getPeriksaTensi()}
                                </td>                                
                                <td>
                                    ${periksa.getPeriksaSuhu()}
                                </td>
                                <td>
                                    ${periksa.getPeriksaBeratBadan()}
                                </td>                        
                                <td>
                                    ${periksa.getPeriksaRiwayatMedis()}
                                </td>                        
                                <td>
                                    ${periksa.getPeriksaKeputusan()}
                                </td>                             
                                <td>

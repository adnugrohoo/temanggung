...
<html lang="en">
    <head>
        ...
        <meta name="description" content="PMI Kabupaten Temanggung">
        <meta name="author" content="Adhi Nugroho">
    ...
    <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li> <a href="#portfolio" class="smoothScroll"> volunteer</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown show-on-hover">
                                <a href="http://phpoll.com/register" class="dropdown-toggle" data-toggle="dropdown">Menu Rumah Sakit <span class="caret"></span></a>
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in">
                                                    <div class="panel-body">
                                                        <table class="table">
                                                            <tr>
                                                                <td>
                                                                    <span class="glyphicon glyphicon-pencil text-primary"></span><a href="#">Data Pasien</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="glyphicon glyphicon-flash text-success"></span><a href="#">Data Dokter</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="glyphicon glyphicon-file text-info"></span><a href="#">Data Petugas</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                ...
                                                <div id="collapseTwo" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <table class="table">
                                                            <tr>
                                                                <td>
                                                                    <a href="http://www.jquery2dotnet.com">Permintaan Kantong Darah</a></span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
        ...
        <div id="headerwrap" id="home" name="home">
            <header class="clearfix">
                ...
                <p>Setetes Darah Anda</p>
                <p>Selamatkan jiwa penderita.</p>
            </header>	    
        </div><!-- /headerwrap -->
